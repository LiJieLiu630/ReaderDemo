 ...
 * @备注：
 */
public class FilterBookListAdapter extends RecyclerView.Adapter<FilterBookListAdapter.BookViewHolder> {
    private List<BookDetailBean> mlist;
    private Context mContext;
    private LayoutInflater mInflater;

    public FilterBookListAdapter(List<BookDetailBean> mlist, Context cntext) {
        this.mlist = mlist;
    ...
    public void onBindViewHolder(BookViewHolder holder, int position) {
        ...
        final BookDetailBean bookListBean = mlist.get(position);
        ...
        holder.tvBookMsg.setText(bookListBean.getMajorCate() + "|+" + bookListBean.getMinorCate());
