...
import com.liulije.readerdemo.utils.FileUtils;
 ...
 * @date 16/8/11.
 */
public class TocListAdapter extends EasyLVAdapter<BookMixAToc> {
    ...
    public TocListAdapter(Context context, List<BookMixAToc> list, String bookId, int currentChapter) {
    ...
    @Override
    public void convert(EasyLVHolder holder, int position, BookMixAToc chapters) {
        TextView tvTocItem = holder.getView(R.id.tvTocItem);
        tvTocItem.setText(chapters.getTitle());
        Drawable drawable;
