 ...
 */
public class ExpendableTextView extends LinearLayout {
    ...
    public ExpendableTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mOpenBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (isOpen) {
                    //to close
                    mTextView.setHeight(mTextView.getLineHeight() * foldLines);
                    mOpenBtn.setImageResource(R.mipmap.iv_expand_down);
                    isOpen = false;

                } else {
                    //to open
                    mTextView.setHeight(mTextView.getLineHeight() * mTextView.getLineCount());
                    mOpenBtn.setImageResource(R.mipmap.iv_expand_up);
                    isOpen = true;
